...
uint8_t uid[4];
MFRC522_t rfID = {SPI1, spi_cs_GPIO_Port, spi_cs_Pin, spi_reset_GPIO_Port, spi_reset_Pin};
...
static void MX_GPIO_Init(void)
{
  ...
  /**/
  LL_GPIO_ResetOutputPin(spi_reset_GPIO_Port, spi_reset_Pin);
  ...
  GPIO_InitStruct.OutputType = LL_GPIO_OUTPUT_PUSHPULL;
  GPIO_InitStruct.Pull = LL_GPIO_PULL_NO;
  LL_GPIO_Init(spi_reset_GPIO_Port, &GPIO_InitStruct);
